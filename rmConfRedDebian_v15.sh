...
#
# rmConfRedDebian_v15.sh - v250924-0919
#
# rmCMD=rmConfRedDebian_v15.sh && bash -c "$(curl -fsSL https://github.com/ricardomonla/RM-rmCMDs/raw/refs/heads/main/${rmCMD})"

rmCMD="rmConfRedDebian_v15.sh"
