...
#
# rmConfiguraRedEnDebian_v16: v250924-1929
#
# rmCMD=rmConfiguraRedEnDebian_v16.sh && bash -c "$(curl -fsSL https://github.com/ricardomonla/RM-rmCMDs/raw/refs/heads/main/rmConfiguraRedEnDebian_v16/${rmCMD})"

rmCMD="rmConfiguraRedEnDebian_v16.sh"
...
# Versión: v250924-2200
# ==============================================================

# --- Variables de Identificación ---
SCRIPT_NAME=$(basename "$0")
SCRIPT_VERSION="v250924-1929"
...
EOF
  ...
  systemctl restart systemd-networkd
  echo -e "${GREEN}✅ Gateway global actualizado a $newgw${RESET}"
}
